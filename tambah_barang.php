...
<html lang="en">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form method="post" action="" >
                            ...
                            <input type="text" name="nama_barang" placeholder="Masukkan Nama Barang"  class="form-control mt-2" required>
                            <input type="text" name="harga_masuk" placeholder="harga_masuk"  class="form-control mt-2" required>
                            <input type="text" name="harga_jual" placeholder="harga_jual"  class="form-control mt-2" required>
                            <input type="number" name="stock" placeholder="Jumlah"  class="form-control mt-2" required>
                            
                             
                            <button type="submit" name="submit" class="btn btn-primary form-control mt-2">Tambah Barang</button>
                            </div>
                        </form>
                        <!-- tutup tambah barang -->
    ...
    <!-- The Modal -->
        <div class="modal fade" id="berhasilTambah">
